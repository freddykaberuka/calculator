...
after cloning Repository [HERE]([url](https://github.com/freddykaberuka/calculator/) open the folder and run npm install to install all the modules in your local storage
